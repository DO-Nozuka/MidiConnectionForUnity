...
namespace MidiConnectionForUnity.StandardDevice
{
       ...
       IMidiModule
    {
        ...
        {
            ChannelState[message.Channel].BankSelect &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnModulationMSB(MidiMessage message)
        {
            ChannelState[message.Channel].Modulation &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnBreathControllerMSB(MidiMessage message)
        {
            ChannelState[message.Channel].BreathController &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined03MSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined03 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnFootControllerMSB(MidiMessage message)
        {
            ChannelState[message.Channel].FootController &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnPortamentoTimeMSB(MidiMessage message)
        {
            ChannelState[message.Channel].PortamentoTime &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnDataEntryMSB(MidiMessage message)
        {
            ChannelState[message.Channel].DataEntry &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnChannelVolumeMSB(MidiMessage message)
        {
            ChannelState[message.Channel].ChannelVolume &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnBalanceMSB(MidiMessage message)
        {
            ChannelState[message.Channel].Balance &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined09MSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined09 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnPanMSB(MidiMessage message)
        {
            ChannelState[message.Channel].Pan &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnExpressionControllerMSB(MidiMessage message)
        {
            ChannelState[message.Channel].ExpressionController &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnEffectControl1MSB(MidiMessage message)
        {
            ChannelState[message.Channel].EffectControl1 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnEffectControl2MSB(MidiMessage message)
        {
            ChannelState[message.Channel].EffectControl2 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined0EMSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined0E &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined0FMSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined0F &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnGeneralPurposeController1MSB(MidiMessage message)
        {
            ChannelState[message.Channel].GeneralPurposeController1 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnGeneralPurposeController2MSB(MidiMessage message)
        {
            ChannelState[message.Channel].GeneralPurposeController2 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnGeneralPurposeController3MSB(MidiMessage message)
        {
            ChannelState[message.Channel].GeneralPurposeController3 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnGeneralPurposeController4MSB(MidiMessage message)
        {
            ChannelState[message.Channel].GeneralPurposeController4 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined14MSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined14 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined15MSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined15 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined16MSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined16 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined17MSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined17 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined18MSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined18 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined19MSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined19 &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined1AMSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined1A &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined1BMSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined1B &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined1CMSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined1C &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined1DMSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined1D &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined1EMSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined1E &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnUndefined1FMSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined1F &= (message.Data2 << 7) + 0b01111111;
        }
        public virtual void OnBankSelectLSB(MidiMessage message)
        {
            ChannelState[message.Channel].BankSelect &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnModulationWheelLSB(MidiMessage message)
        {
            ChannelState[message.Channel].Modulation &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnBreathControllerLSB(MidiMessage message)
        {
            ChannelState[message.Channel].BreathController &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined03LSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined03 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnFootControllerLSB(MidiMessage message)
        {
            ChannelState[message.Channel].FootController &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnPortamentoTimeLSB(MidiMessage message)
        {
            ChannelState[message.Channel].PortamentoTime &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnDataEntryLSB(MidiMessage message)
        {
            ChannelState[message.Channel].DataEntry &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnChannelVolumeLSB(MidiMessage message)
        {
            ChannelState[message.Channel].ChannelVolume &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnBalanceLSB(MidiMessage message)
        {
            ChannelState[message.Channel].Balance &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined09LSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined09 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnPanLSB(MidiMessage message)
        {
            ChannelState[message.Channel].Pan &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnExpressionControllerLSB(MidiMessage message)
        {
            ChannelState[message.Channel].ExpressionController &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnEffectControl1LSB(MidiMessage message)
        {
            ChannelState[message.Channel].EffectControl1 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnEffectControl2LSB(MidiMessage message)
        {
            ChannelState[message.Channel].EffectControl2 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined0ELSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined0E &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined0FLSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined0F &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnGeneralPurposeController1LSB(MidiMessage message)
        {
            ChannelState[message.Channel].GeneralPurposeController1 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnGeneralPurposeController2LSB(MidiMessage message)
        {
            ChannelState[message.Channel].GeneralPurposeController2 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnGeneralPurposeController3LSB(MidiMessage message)
        {
            ChannelState[message.Channel].GeneralPurposeController3 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnGeneralPurposeController4LSB(MidiMessage message)
        {
            ChannelState[message.Channel].GeneralPurposeController4 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined14LSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined14 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined15LSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined15 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined16LSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined16 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined17LSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined17 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined18LSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined18 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined19LSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined19 &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined1ALSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined1A &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined1BLSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined1B &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined1CLSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined1C &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined1DLSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined1D &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined1ELSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined1E &= 0b0011111110000000 + message.Data2;
        }
        public virtual void OnUndefined1FLSB(MidiMessage message)
        {
            ChannelState[message.Channel].Undefined1F &= 0b0011111110000000 + message.Data2;
        }
